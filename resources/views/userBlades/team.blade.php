            ...
            <td>
                <div class="tooltip-wrapper">
                    <form action="{{ route('admin-actions.destroy',$userData->id) }}" method="POST">
                        ...
                        <button type="submit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to disable user" class="btn delete" onclick="if (!confirm('{{ $userData->firstname }} will be permanently disabled, are you sure?')) { return false }">
